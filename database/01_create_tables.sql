...
ALTER TABLE TAI_KHOAN ADD COLUMN reset_otp VARCHAR(6);
ALTER TABLE TAI_KHOAN ADD COLUMN otp_expires TIMESTAMP;
ALTER TABLE TAI_KHOAN ADD COLUMN trang_thai trang_thai_enum DEFAULT 'Đang hoạt động';
